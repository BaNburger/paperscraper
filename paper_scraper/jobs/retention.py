...
from paper_scraper.core.database import engine as async_engine
...
async def apply_retention_policies_task(
    ...
    async with async_session() as db:
        try:
            ...
            results_summary["completed_at"] = datetime.now(timezone.utc).isoformat()
