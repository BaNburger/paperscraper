...
def upgrade() -> None:
    ...
    op.create_index("ix_repository_sources_org_id", "repository_sources", ["organization_id"])
    op.create_index("ix_repository_sources_created_by_id", "repository_sources", ["created_by_id"])
